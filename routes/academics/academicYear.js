...
AcademicYearRouter.route('/').post(IsLogin, isAdmin).get(IsLogin, isAdmin);
AcademicYearRouter.route('/:id').get(IsLogin, isAdmin).put(IsLogin, isAdmin).delete(IsLogin, isAdmin);
